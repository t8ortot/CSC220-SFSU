...
class PlayingCardException extends Exception {
    ...
    */
    ...
    /**
    * Contructor to creare a PlayingCardExecption object with message
    */
...
class Decks {
    ...
    /**
     * Creates one deck of 52 or 54 (withJokers = false or true) playing cards in originalDecks and copy them to gameDecks.
     * @param withJokers specifies if jokers should be in deck
     */
    public Decks(boolean withJokers) {
        // uses constructor below with default value of 1 deck
        this(1, withJokers);
    }
